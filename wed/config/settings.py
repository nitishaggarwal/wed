...
class Common(Configuration):
    ...
    LOCAL_APPS = (
        ...
        'wedding',  # Your stuff: custom apps go here
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/wed')
...
class Local(Common):
    ...
    DATABASES = values.DatabaseURLValue(
        'postgres://postgres:12345@localhost/wed')
